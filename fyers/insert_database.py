...
class database_ticks:#(name,fyers,token,cred_dict):
    ...
    def database(self):
        ...
        #ws.websocket_data = custom_message
        fyersSocket = ws.FyersSocket(access_token=self.access_token,run_background=False,log_path="/Users/ravisekharsapare/.spyder-py3/algo-trading-using-fyers-broker-api-main/fyers")
