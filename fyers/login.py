...
class login:
    ...
    def get_token(self):
        ...
        driver = webdriver.Chrome('/Users/ravisekharsapare/Downloads/Zerodha Kite/chromedriver')
       ...
       #driver = webdriver.Remote(service.service_url, options)
        ...
        username = driver.find_element_by_xpath('/html/body/section[1]/div[3]/div[3]/form/div[1]/input')
        username.send_keys(self.user_id)
        driver.find_element_by_xpath('/html/body/section[1]/div[3]/div[3]/form/button').click()
        sleep(5)
        password = driver.find_element_by_xpath('/html/body/section[2]/div[3]/div[3]/form/div[1]/input')
        password.send_keys(self.password)
        driver.find_element_by_xpath('/html/body/section[2]/div[3]/div[3]/form/button').click()        
        ...
        driver.find_element_by_css_selector('input.pin-field:nth-child(1)').send_keys(2)
        driver.find_element_by_css_selector('input.pin-field:nth-child(2)').send_keys(5)
        driver.find_element_by_css_selector('input.pin-field:nth-child(3)').send_keys(4)
        driver.find_element_by_css_selector('input.pin-field:nth-child(4)').send_keys(2)
        try:
