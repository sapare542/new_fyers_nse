...
stocks=open('/Users/ravisekharsapare/.spyder-py3/algo-trading-using-fyers-broker-api-main/fyers/stock_selection.txt').read().split('\n')
allowed_stocks=[]
for i in stocks:
...
for i in allowed_stocks:
    u+=str(i)
    u=u+'\n'
open('/Users/ravisekharsapare/.spyder-py3/algo-trading-using-fyers-broker-api-main/fyers/stock_selection.txt','w').write(u)
